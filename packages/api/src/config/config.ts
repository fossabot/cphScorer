export class Configuration {
  ...
  public readonly database: string = process.env.DATABASE_URL ?? 'postgres://psql:psql@127.0.0.1:5432/psql'
  public readonly port: string | number = process.env.PORT ?? 3000
