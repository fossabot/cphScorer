...
export class MatchController {
  constructor (private readonly teamService: TeamService, private readonly rankingService: RankingService) { }
  ...
  async updateScore (@Body() { match, type }: MatchUpdateDTO): Promise<void> {
    const useCase = new UpdateScore(this.rankingService.dao, this.teamService.dao)
